...
parser.add_argument("--attention-type", type=str, default="flash", help="attention type: 'flash' or 'linear'")
...
def build_model_meta(depth):
    ...
    config = GPTConfig(
        ...
        window_pattern=args.window_pattern, attention_type=args.attention_type
    )
